function [v, idx_P_slack, P_min] = solve_comm(M,num,elems,params,sn,se,sparams_step, Gconv,w)
...
while any(~isconverge) && max(cntr)<n_iter_max
    ...
    rslts_new = solve_unconverged(isconverge,sparams_step,Ma, se, idx_P_slack);
    idx_loop = 0;
